...
for subj_id, study_id, xnat_id, scan_date, priority in [
        (1, 1231, 'MRH100_124_MR02', '10/04/2017', 0),
        (2, 1244, 'SHOULD_NOT_BE_SHOWN_NEWER_SESSION', '11/02/2018', 0),
        (2, 1254, 'MMH092_009_MRPT01', '12/02/2018', 0),
        (3, 1366, 'MRH999_999_MR01', '11/10/2017', 0),
        (3, 1500, 'SHOULD_NOT_BE_SHOWN_PREV_REPORT', '11/5/2018', 0),
        (3, 1600, 'MRH999_999_MR99', '11/1/2019', 2),
        (4, 3413, 'MRH088_065_MR01', '13/01/2019', 1),
        (5, 4500, 'MRH112_002_MR01', '11/02/2019', 0),
        (6, 5003, 'MRH100_025_MR01', '1/08/2017', 1),
        (7, 9834, 'MRH099_003_MR03', '10/11/2018', 1)]:
    img_session = img_sessions[study_id] = ImagingSession(
        study_id, subj_id, xnat_id, datetime.strptime(scan_date, '%d/%m/%Y'),
